  ...
  return (
    ...
    <div className="flex flex-wrap justify-center gap-14">
      ...
      <div className="flex flex-col mb-10 sm:mb-0">
        ...
        <ul className="space-y-2 text-sm font-light text-gray-600">
          <li className="mt-4"><a href="#">Help/FAQ</a></li>
      ...
      <div className="flex flex-col mb-10 sm:mb-0">
        ...
        <ul className="space-y-2 text-sm font-light text-gray-600">
          <li className="mt-4"><a href="#">Airline fees</a></li>
      ...
      <div className="flex flex-col items-center col-span-2 mb-16 md:items-start sm:mb-0 md:ml-8">
        <ul className="flex gap-6 font-light text-gray-600">
          <li>
            <a href="#" className="grid w-10 h-10 bg-white rounded-full md:w-8 md:h-8 drop-shadow-2xl place-items-center"
              aria-label="Facebook Icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="5.857" height="12.69" viewBox="0 0 5.857 12.69">
          ...
          <li>
            <a href="#" className="grid w-10 h-10 bg-white rounded-full md:w-8 md:h-8 drop-shadow-2xl place-items-center"
              ...
              <svg id="instagram_1" data-name="instagram 1" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                viewBox="0 0 16 16">
                <g id="Group">
                  ...
                  <g id="Group-3" data-name="Group">
                    <path id="Vector-2" data-name="Vector" d="M.938,0a.938.938,0,1,0,.938.938A.939.939,0,0,0,.938,0Z"
        ...
        <div className="flex w-full">
          <a href="#" className="flex items-center justify-center p-2 pl-4 pr-5 bg-black rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" width="18.562" height="20" viewBox="0 0 18.562 20">
              <g id="google-play_1" data-name="google-play 1" transform="translate(-0.719)">
                <path id="Vector"
          ...
          <a href="#" className="flex items-center justify-center p-2 pl-4 pr-5 ml-2 bg-black rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="22" viewBox="0 0 13.124 16">
              <g id="apple_2_1" data-name="apple (2) 1" transform="translate(-1163.438 -4561)">
                <g id="Group">
                  <path id="Vector"
      ...
      <div className="space-y-4 text-sm">
        <p className="mt-8 text-sm font-poppins">All rights reserved@jadoo.co</p>
      </div>
    </div>
  </footer>
  )
