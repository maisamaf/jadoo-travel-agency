  ...
  return (
    ...
    <div className="relative flex flex-col gap-20 my-20 md:flex-row md:gap-10 md:justify-between">
      <div className="flex flex-col gap-12">
        <div className="flex items-center justify-center max-w-md">
          <div className="grid p-3 rounded-xl w-16 h-[3.2rem] bg-[#F0BB1F] place-items-center">
            <img src="./images/selection .png" className="w-6 h-6" role="presentation" />
          </div>
        ...
        <div className="flex items-center justify-center max-w-md">
          <div className="grid p-3 rounded-xl w-16 h-[3.2rem] bg-[#F15A2B] place-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 22.054 17.86">
              <g id="water-sport_1" data-name="water-sport 1" transform="translate(-198.973 -2750.069)">
                <path id="Vector"
                  ...
                  transform="translate(205.676 2766.63)" fill="#fff" />
                <path id="Vector-2" data-name="Vector"
                  ...
                  transform="translate(198.973 2766.631)" fill="#fff" />
                <path id="Vector-3" data-name="Vector"
                  ...
                  transform="translate(198.973 2764.36)" fill="#fff" />
                <path id="Vector-4" data-name="Vector"
                  ...
                  transform="translate(215.617 2762.089)" fill="#fff" />
                <path id="Vector-5" data-name="Vector"
                  ...
                  transform="translate(198.973 2762.09)" fill="#fff" />
                <path id="Vector-6" data-name="Vector"
                  d="M19.846,1.3A2.209,2.209,0,0,1,18.578.929a1.717,1.717,0,0,0-1.878,0,2.359,2.359,0,0,1-1.267.369A2.359,2.359,0,0,1,14.166.929a1.714,1.714,0,0,0-1.876,0,2.358,2.358,0,0,1-1.267.369A2.358,2.358,0,0,1,9.757.929a1.714,1.714,0,0,0-1.876,0A2.2,2.2,0,0,1,6.614,1.3,2.2,2.2,0,0,1,5.347.929,1.57,1.57,0,0,0,4.41.649a1.57,1.57,0,0,0-.938.28A2.2,2.2,0,0,1,2.207,1.3,2.2,2.2,0,0,1,.94.929,1.57,1.57,0,0,0,0,.649V0A2.2,2.2,0,0,1,1.267.37a1.572,1.572,0,0,0,.939.28A1.57,1.57,0,0,0,3.143.37,2.2,2.2,0,0,1,4.408,0,2.2,2.2,0,0,1,5.676.37a1.57,1.57,0,0,0,.938.28A1.57,1.57,0,0,0,7.552.37a2.358,2.358,0,0,1,2.534,0,1.714,1.714,0,0,0,.938.28,1.714,1.714,0,0,0,.938-.28A2.358,2.358,0,0,1,14.5.37a1.714,1.714,0,0,0,.938.28,1.714,1.714,0,0,0,.938-.28,2.362,2.362,0,0,1,2.536,0,1.719,1.719,0,0,0,.939.279A1.719,1.719,0,0,0,20.786.37,2.209,2.209,0,0,1,22.054,0V.649a1.573,1.573,0,0,0-.941.28,2.209,2.209,0,0,1-1.267.369Z"
                  transform="translate(198.973 2759.82)" fill="#fff" />
                <path id="Vector-7" data-name="Vector"
                  ...
                  transform="translate(208.756 2750.069)" fill="#fff" />
                <path id="Vector-8" data-name="Vector" d="M0,0H4.5V.648H0Z"
                  transform="matrix(0.876, -0.483, 0.483, 0.876, 203.681, 2759.906)" fill="#fff" />
                <path id="Vector-9" data-name="Vector"
                  ...
                  transform="translate(214.703 2753.82)" fill="#fff" />
              </g>
            </svg>
          </div>
          <div className="flex flex-col mx-4 text-[#5E6282] break-words font-poppins w-max">
      ...
      <div className="absolute -right-28 bottom-32 md:-top-44 md:-right-32">
        <img src="./images/blue-circle.png" className="z-0 w-96 h-96" role="presentation" />
      </div>
      <div className="z-20 p-6 mt-6 bg-white shadow-xl md:-mt-16 rounded-2xl">
        <div className="flex flex-col mt-4 font-poppins">
          <img src="./images/greece-trip.png" className="z-10 object-cover" alt="Image of a girl in greece" />
          ...
          <div className="flex gap-4 mt-2 mb-8">
            <div className="grid w-10 h-10 rounded-full place-items-center bg-[#F5F5F5] cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" width="13.952" height="14" viewBox="0 0 13.952 14">
                <g id="leaf_1" data-name="leaf 1" transform="translate(-0.024 0)">
                  <g id="Group">
                    <g id="Group-2" data-name="Group">
                      <path id="Vector"
                        ...
                        transform="translate(0.024 0)" fill="#84829a" />
                    </g>
                  </g>
                  <g id="Group-3" data-name="Group">
                    <g id="Group-4" data-name="Group">
                      <path id="Vector-2" data-name="Vector"
                        ...
                        transform="translate(2.472 2.297)" fill="#84829a" />
                    </g>
                  </g>
                </g>
              </svg>
            ...
            <div className="grid w-10 h-10 rounded-full place-items-center bg-[#F5F5F5] cursor-pointer">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
                <g id="map_1" data-name="map 1" transform="translate(-0.001 0)">
                  <g id="Group">
                    <g id="Group-2" data-name="Group">
                      <path id="Vector"
                        ...
                        transform="translate(0.001 0)" fill="#84829a" />
                    </g>
                  </g>
                </g>
              </svg>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="11.596" height="11.563" viewBox="0 0 11.596 11.563">
                <g id="send_2" data-name="send 2" transform="translate(-1.186 -1.219)">
                  <path id="Vector"
                    ...
                    transform="translate(1.186 1.219)" fill="#84829a" />
                  <path id="Vector-2" data-name="Vector"
                    ...
                    transform="translate(6.405 1.657)" fill="#84829a" />
                </g>
              </svg>
            </div>
          </div>
          <div className="flex justify-between">
                  ...
                  <g id="Group-2" data-name="Group">
                    <g id="Group-3" data-name="Group">
                      <path id="Vector"
                        ...
                        transform="translate(856 2843) rotate(180)" fill="#84829a" />
                      <path id="Vector-2" data-name="Vector"
                        ...
                        transform="translate(849.333 2846.733) rotate(180)" fill="#84829a" />
                      <path id="Vector-3" data-name="Vector"
                        d="M1.867,0H.267A.267.267,0,0,1,0-.267v-1.6a.267.267,0,0,1,.267-.267h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0ZM1.6-1.6H.533V-.533H1.6Z"
                        transform="translate(849.333 2844.067) rotate(180)" fill="#84829a" />
                      <path id="Vector-4" data-name="Vector"
                        d="M1.867,0H.267A.267.267,0,0,1,0-.267v-1.6a.267.267,0,0,1,.267-.267h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0ZM1.6-1.6H.533V-.533H1.6Z"
                        transform="translate(852 2846.733) rotate(180)" fill="#84829a" />
                      <path id="Vector-5" data-name="Vector"
                        d="M1.867,0H.267A.267.267,0,0,1,0-.267v-1.6a.267.267,0,0,1,.267-.267h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0ZM1.6-1.6H.533V-.533H1.6Z"
                        transform="translate(852 2844.067) rotate(180)" fill="#84829a" />
                      <path id="Vector-6" data-name="Vector"
                        d="M1.867,0H.267A.267.267,0,0,1,0-.267v-1.6a.267.267,0,0,1,.267-.267h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0ZM1.6-1.6H.533V-.533H1.6Z"
                        transform="translate(852 2849.4) rotate(180)" fill="#84829a" />
                      <path id="Vector-7" data-name="Vector"
                        d="M1.867,0H.267A.267.267,0,0,1,0-.267v-1.6a.267.267,0,0,1,.267-.267h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0ZM1.6-1.6H.533V-.533H1.6Z"
                        transform="translate(852 2852.067) rotate(180)" fill="#84829a" />
                      <path id="Vector-8" data-name="Vector"
                        ...
                        transform="translate(845.333 2853.133) rotate(180)" fill="#84829a" />
                      <path id="Vector-9" data-name="Vector"
                        d="M.267-2.133h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0H.267A.267.267,0,0,1,0-.267v-1.6A.267.267,0,0,1,.267-2.133Zm.267,1.6H1.6V-1.6H.533Z"
                        transform="translate(845.333 2850.467) rotate(180)" fill="#84829a" />
                      <path id="Vector-10" data-name="Vector"
                        d="M.267-2.133h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0H.267A.267.267,0,0,1,0-.267v-1.6A.267.267,0,0,1,.267-2.133Zm.267,1.6H1.6V-1.6H.533Z"
                        transform="translate(845.333 2855.8) rotate(180)" fill="#84829a" />
                      <path id="Vector-11" data-name="Vector"
                        d="M.267-2.133h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0H.267A.267.267,0,0,1,0-.267v-1.6A.267.267,0,0,1,.267-2.133Zm.267,1.6H1.6V-1.6H.533Z"
                        transform="translate(848 2853.133) rotate(180)" fill="#84829a" />
                      <path id="Vector-12" data-name="Vector"
                        d="M.267-2.133h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0H.267A.267.267,0,0,1,0-.267v-1.6A.267.267,0,0,1,.267-2.133Zm.267,1.6H1.6V-1.6H.533Z"
                        transform="translate(848 2850.467) rotate(180)" fill="#84829a" />
                      <path id="Vector-13" data-name="Vector"
                        d="M.267-2.133h1.6a.267.267,0,0,1,.267.267v1.6A.267.267,0,0,1,1.867,0H.267A.267.267,0,0,1,0-.267v-1.6A.267.267,0,0,1,.267-2.133Zm.267,1.6H1.6V-1.6H.533Z"
                        transform="translate(848 2855.8) rotate(180)" fill="#84829a" />
                    </g>
                  </g>
                </g>
              </svg>
            ...
            <div className="relative group">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18.585" viewBox="0 0 20 18.585">
                <g id="heart_6_1" data-name="heart (6) 1" transform="translate(-1140 -2844.708)">
                  <g id="Group">
                    <g id="Group-2" data-name="Group">
                      <path id="Vector"
                        ...
                        transform="translate(1140 2844.708)" fill="#4152ca" />
                    </g>
                  </g>
                </g>
              </svg>
              <div
                ...
                <div className="flex w-full">
                  <img src="./images/minar.png" className="object-cover w-12 h-12 rounded-full" alt="Image of a minar" />
                  <div className="flex flex-col w-full mx-2">
                    <p className="font-poppins text-sm text-[#64636e]">Ongoing</p>
